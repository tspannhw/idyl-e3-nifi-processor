...
import com.mtnfog.IdylE3Processor;
import com.mtnfog.entity.Entity;

public class IdylE3ProcessorTest {

    private TestRunner runner;

    @Before
    public void init() {
    	runner = TestRunners.newTestRunner(IdylE3Processor.class);
    }
    ...
    public void testOnTrigger() throws IOException {
        ...
        runner.setProperty(IdylE3Processor.IDYL_E3_HOST, "http://localhost:9000/");
        runner.setProperty(IdylE3Processor.IDYL_E3_CONTEXT, "${uuid}");
        runner.enqueue(content);
        runner.run(1);
        runner.assertQueueEmpty();
        
        List<MockFlowFile> results = runner.getFlowFilesForRelationship(IdylE3Processor.REL_SUCCESS);
